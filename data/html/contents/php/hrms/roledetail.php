...
<body>
		...
		<div class="row-fluid">
			...
			<ul class="breadcrumb">
				...
				<li>
					<i class="icon-edit"></i>
					<a href="#">role detail information</a>
				</li>
			</ul>
			...
			<div class="row-fluid sortable">
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon white edit"></i><span class="break"></span>Role Form Elements</h2>
						<div class="box-icon">
						  ...
						  <fieldset>
							<div class="control-group">
							  ...
							  <div class="controls">
								...
								<p class="help-block">Start typing to role name!</p>
							  </div>
							</div>
							<div class="control-group">
							  <label class="control-label" for="typeahead">Role div</label>
							  <div class="controls">
								<input type="text" class="span6 typeahead" id="name"  data-provide="typeahead" data-items="4">
							  </div>
							</div>
							<div class="control-group hidden-phone">
							  <label class="control-label" for="textarea2">Role Comment</label>
							  <div class="controls">
